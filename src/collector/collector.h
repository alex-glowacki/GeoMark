 ...
 * The collector owns the port and closes it on collector_stop().
 ...
 * without closing and reopening the device (which can cause select() to
 * stop firing on hardware UARTs like ttyAMA0).
